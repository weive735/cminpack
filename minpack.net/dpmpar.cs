namespace MinpackDotNet {
    ...
    class Dpmar {
        ...
        internal static double dpmpar(int i)
        {
            /*     ********** */
            ...
            switch (i) {
                case 1:
                    return double.Epsilon; /* 2.2204460492503131e-16 | 1.19209290e-07F */
                case 2:
                    return double.MinValue;    /* 2.2250738585072014e-308 | 1.17549435e-38F */
                default:
                    return double.MaxValue;    /* 1.7976931348623157e+308 | 3.40282347e+38F */
            }
