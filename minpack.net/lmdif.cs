...
using static MinpackDotNet.Dpmpar;
using static MinpackDotNet.Enorm;
...
namespace MinpackDotNet
{
    static partial class Lmdif
    {
        ...
        internal static int lmdif(cminpack_fcn_mn fcn_mn, object p, int m, int n, double[] x,
             ...
             wa4)
        {
            ...
            for (; ; )
            {
                ...
                iflag = Fdjac2.fdjac2(fcn_mn, p, m, n, x, fvec, fjac, ldfjac, epsfcn, wa4);
                nfev += n;
                if (iflag < 0)
                {
                    goto TERMINATE;
                ...
                //      wa1, wa2, wa3);
                Qrfac.qrfac(m, n, fjac, ldfjac, true, ipvt, ref n, wa1, wa2, wa3);
                ...
                do
                {
                    ...
                    //      &par, wa1, wa2, wa3, wa4);
                    Lmpar.lmpar(n, fjac, ldfjac, ipvt, diag, qtf, delta, ref par, wa1, wa2, wa3, wa4);
