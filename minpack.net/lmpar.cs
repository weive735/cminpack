...
namespace MinpackDotNet
{
    static class Lmpar
    {
        ...
        */
        ...
        //	real *wa2)
        internal static void lmpar(int n, double[] r, int ldr,
            int[] ipvt, double[] diag, double[] qtb, double delta,
            ref double par, double[] x, double[] sdiag, double[] wa1,
            double[] wa2)
        {
            /* Initialized data */
            ...
            for (; ; )
            {
                ...
                Qrsolv.qrsolv(n, r, ldr, ipvt, wa1, qtb, x, sdiag, wa2);
                for (j = 0; j < n; ++j)
                {
                    wa2[j] = diag[j] * x[j];
                }
